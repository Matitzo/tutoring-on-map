...
import MyAnnouncementsData from "./MyAnnouncementsData.js";
import {
  StyledMyAnnouncementsContainer,
  StyledMyAnnouncementWrapper,
  StyledBtnWrapper,
  StyledIcon,
  StyledMyAnnouncementsWrapper,
} from "../styles/MyAnnouncements.styled";
import { StyledProfileListContainer } from "../styles/Profile.styled";
  ...
  function getMyAnnouncements() {
    ...
    Axios.get(
      ...
      .then((res) => {
        ...
        setNrOfLocations(
          res.data.reduce(function (a, announcement) {
            return a + JSON.parse(announcement.location).length;
          }, 0)
        );
    ...
    <StyledMyAnnouncementsContainer>
      <StyledProfileListContainer>
        <MyAnnouncementsData
          ...
          nrOfAnnouncements={myAnnouncements.length}
